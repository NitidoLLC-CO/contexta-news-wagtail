"""
Django settings for contexta_news project.
...
if host := hostname_from_url(os.environ.get("WAGTAILADMIN_BASE_URL")):
    DEFAULT_ALLOWED_HOSTS.append(host)

ALLOWED_HOSTS = env_list("ALLOWED_HOSTS", DEFAULT_ALLOWED_HOSTS)

DEFAULT_CSRF_TRUSTED_ORIGINS = ["https://*.up.railway.app"]
if RAILWAY_PUBLIC_DOMAIN:
    DEFAULT_CSRF_TRUSTED_ORIGINS.append(f"https://{RAILWAY_PUBLIC_DOMAIN}")
if admin_base_url := os.environ.get("WAGTAILADMIN_BASE_URL"):
    DEFAULT_CSRF_TRUSTED_ORIGINS.append(admin_base_url.rstrip("/"))
...
ROOT_URLCONF = "contexta_news.urls"
...
WSGI_APPLICATION = "contexta_news.wsgi.application"
...
WAGTAIL_SITE_NAME = os.environ.get("WAGTAIL_SITE_NAME", "CONTEXTRA News")
...
WAGTAILADMIN_BASE_URL = os.environ.get(
    ...
    f"https://{RAILWAY_PUBLIC_DOMAIN}" if RAILWAY_PUBLIC_DOMAIN else "http://example.com",
)
